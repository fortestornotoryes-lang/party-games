...
export const THEME_TOKENS: Record<GameTheme, ThemeTokens> = {
  ...
  lime: {
    text:         'text-premium-lime',
    solid:        'bg-premium-lime',
    bg5:          'bg-premium-lime/5',
    bg10:         'bg-premium-lime/10',
    bg20:         'bg-premium-lime/20',
    border20:     'border-premium-lime/20',
    border30:     'border-premium-lime/30',
    border40:     'border-premium-lime/40',
    indexBg:      'bg-premium-lime/20 text-premium-lime border-premium-lime/30',
    activeOption: 'bg-premium-lime/10 border-premium-lime/40 text-premium-lime shadow-[0_0_20px_rgba(132,204,22,0.12)]',
    button:       'bg-premium-lime hover:bg-[#a3e635] active:scale-95 shadow-[0_20px_50px_rgba(132,204,22,0.3)]',
    gradient:     'bg-[radial-gradient(circle_at_50%_0%,rgba(132,204,22,0.15),transparent_70%)]',
    focus:        'focus:border-premium-lime/50',
    addHover:     'hover:bg-premium-lime/5 hover:text-white/80 hover:border-premium-lime/20',
    closeHover:   'hover:bg-premium-lime/10 hover:text-premium-lime',
    glow:         'shadow-premium-lime/20',
    headerTheme:  'border-premium-lime/50 text-premium-lime',
  },
  teal: {
    text:         'text-premium-teal',
    solid:        'bg-premium-teal',
    bg5:          'bg-premium-teal/5',
    bg10:         'bg-premium-teal/10',
    bg20:         'bg-premium-teal/20',
    border20:     'border-premium-teal/20',
    border30:     'border-premium-teal/30',
    border40:     'border-premium-teal/40',
    indexBg:      'bg-premium-teal/20 text-premium-teal border-premium-teal/30',
    activeOption: 'bg-premium-teal/10 border-premium-teal/40 text-premium-teal shadow-[0_0_20px_rgba(20,184,166,0.12)]',
    button:       'bg-premium-teal hover:bg-[#2dd4bf] active:scale-95 shadow-[0_20px_50px_rgba(20,184,166,0.3)]',
    gradient:     'bg-[radial-gradient(circle_at_50%_0%,rgba(20,184,166,0.15),transparent_70%)]',
    focus:        'focus:border-premium-teal/50',
    addHover:     'hover:bg-premium-teal/5 hover:text-white/80 hover:border-premium-teal/20',
    closeHover:   'hover:bg-premium-teal/10 hover:text-premium-teal',
    glow:         'shadow-premium-teal/20',
    headerTheme:  'border-premium-teal/50 text-premium-teal',
  },
  indigo: {
    text:         'text-premium-indigo',
    solid:        'bg-premium-indigo',
    bg5:          'bg-premium-indigo/5',
    bg10:         'bg-premium-indigo/10',
    bg20:         'bg-premium-indigo/20',
    border20:     'border-premium-indigo/20',
    border30:     'border-premium-indigo/30',
    border40:     'border-premium-indigo/40',
    indexBg:      'bg-premium-indigo/20 text-premium-indigo border-premium-indigo/30',
    activeOption: 'bg-premium-indigo/10 border-premium-indigo/40 text-premium-indigo shadow-[0_0_20px_rgba(99,102,241,0.12)]',
    button:       'bg-premium-indigo hover:bg-[#818cf8] active:scale-95 shadow-[0_20px_50px_rgba(99,102,241,0.3)]',
    gradient:     'bg-[radial-gradient(circle_at_50%_0%,rgba(99,102,241,0.15),transparent_70%)]',
    focus:        'focus:border-premium-indigo/50',
    addHover:     'hover:bg-premium-indigo/5 hover:text-white/80 hover:border-premium-indigo/20',
    closeHover:   'hover:bg-premium-indigo/10 hover:text-premium-indigo',
    glow:         'shadow-premium-indigo/20',
    headerTheme:  'border-premium-indigo/50 text-premium-indigo',
  },
};
