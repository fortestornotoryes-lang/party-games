...
export const ru: Translations = {
    ...
    mafia: {
        ...
        inDevelopment: 'Этот режим игры находится в разработке. Используйте это приложение как помощника для раздачи ролей или ведения игры.',
        goBack: 'Вернуться',
    },
    connect_four: {
        title: 'ЧЕТЫРЕ В РЯД',
    ...
    memo_risk: {
        ...
        tapToStart: 'Нажми, чтобы начать ход',
        passInstruction: 'Запоминай поле — открывай только цели',
        findLabel: 'Ищи',
        avoidLabel: 'Избегай',
    ...
    wavelength: {
        ...
        psychicInstruction: '{{psychic}}, возьми телефон! Только ты должен видеть секретную цель. Убедись, что остальные не смотрят.',
        iAmReady: 'Я ГОТОВ',
