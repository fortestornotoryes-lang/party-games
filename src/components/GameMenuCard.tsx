...
export const GameMenuCard: React.FC<GameMenuCardProps> = ({
    ...
    return (
        ...
        >
            ...
            <div className={`absolute left-0 top-0 bottom-0 w-1.25 rounded-r-full ${t.solid} opacity-75`} />

            {/* Icon */}
            <div className={`w-13 h-13 rounded-premium-md ${t.solid} flex items-center justify-center relative overflow-hidden shrink-0 ml-2.5`}>
            ...
            <div className="flex-1 min-w-0 relative z-10">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                    <span className={`inline-flex items-center gap-1.5 px-2.5 py-1.25 rounded-premium-sm ${t.bg10} ${t.text} border border-current/25 text-[9px] font-black uppercase tracking-[0.15em]`}>
