...
export const MainMenu: React.FC<MainMenuProps> = ({ onSelectGame }) => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-6 bg-[#0a0502] text-[#e5e7eb] font-sans">
      ...
      >
        ...
        <div className="space-y-4">
          <motion.button
            ...
            className="w-full p-6 bg-white/5 border border-white/10 rounded-[2.5rem] flex items-center justify-between group hover:border-red-500/50 hover:bg-red-500/5 transition-all text-left"
          >
            <div className="flex items-center space-x-5">
              ...
              <div>
                <h3 className="text-xl font-bold uppercase tracking-tight italic">Найти Шпиона</h3>
          ...
          <motion.button
            ...
            className="w-full p-6 bg-white/5 border border-white/10 rounded-[2.5rem] flex items-center justify-between group hover:border-sky-500/50 hover:bg-sky-500/5 transition-all text-left"
          >
            <div className="flex items-center space-x-5">
              ...
              <div>
                <h3 className="text-xl font-bold uppercase tracking-tight italic">Alias Rapid</h3>
                <div className="flex items-center space-x-2 text-[10px] text-gray-500 font-bold uppercase tracking-widest mt-1">
                  <Users className="w-3 h-3" />
                  <span>2+ Игрока</span>
                </div>
          ...
          <motion.button
            ...
            className="w-full p-6 bg-white/5 border border-white/10 rounded-[2.5rem] flex items-center justify-between group hover:border-emerald-500/50 hover:bg-emerald-500/5 transition-all text-left"
          >
            <div className="flex items-center space-x-5">
              ...
              <div>
                <h3 className="text-xl font-bold uppercase tracking-tight italic">Рисовальщик</h3>
                <div className="flex items-center space-x-2 text-[10px] text-gray-500 font-bold uppercase tracking-widest mt-1">
                  <Users className="w-3 h-3" />
                  <span>4-7 Игроков</span>
                </div>
          ...
          <motion.button
            ...
            className="w-full p-6 bg-white/5 border border-white/10 rounded-[2.5rem] flex items-center justify-between group hover:border-blue-500/50 hover:bg-blue-500/5 transition-all text-left"
          >
            <div className="flex items-center space-x-5">
              ...
              <div>
                <h3 className="text-xl font-bold uppercase tracking-tight italic">Сопротивление</h3>
                <div className="flex items-center space-x-2 text-[10px] text-gray-500 font-bold uppercase tracking-widest mt-1">
                  <Users className="w-3 h-3" />
          ...
          <motion.button
            ...
            className="w-full p-6 bg-white/5 border border-white/10 rounded-[2.5rem] flex items-center justify-between group hover:border-purple-500/50 hover:bg-purple-500/5 transition-all text-left"
          >
            <div className="flex items-center space-x-5">
              ...
              <div>
                <h3 className="text-xl font-bold uppercase tracking-tight italic">Длина волны</h3>
                <div className="flex items-center space-x-2 text-[10px] text-gray-500 font-bold uppercase tracking-widest mt-1">
                  <Users className="w-3 h-3" />
                  <span>2+ Игроков</span>
                </div>
          ...
          <motion.button
            ...
            className="w-full p-6 bg-white/5 border border-white/10 rounded-[2.5rem] flex items-center justify-between group hover:border-orange-500/50 hover:bg-orange-500/5 transition-all text-left"
          >
            <div className="flex items-center space-x-5">
              ...
              <div>
                <h3 className="text-xl font-bold uppercase tracking-tight italic">Испорченный телефон</h3>
                <div className="flex items-center space-x-2 text-[10px] text-gray-500 font-bold uppercase tracking-widest mt-1">
                  <Users className="w-3 h-3" />
          ...
          >
            <div className="flex items-center space-x-5">
              ...
              <div>
                <h3 className="text-xl font-bold uppercase tracking-tight italic">Намек понял</h3>
                <div className="flex items-center space-x-2 text-[10px] text-gray-500 font-bold uppercase tracking-widest mt-1">
                  <Users className="w-3 h-3" />
        ...
        <div className="pt-8 border-t border-white/5 text-center">
          <p className="text-[9px] text-gray-700 font-mono tracking-[0.5em] uppercase italic">System ready // Status: Online</p>
        </div>
      </motion.div>
    </div>
  );
