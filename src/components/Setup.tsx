...
export const Setup: React.FC<SetupProps> = ({
    ...
    const [names, setNames] = useState<string[]>(
        Array.from({length: minPlayers}, (_, i) => DEFAULT_NAMES[i] ?? `${playerPlaceholder} ${i + 1}`)
    );
    ...
    return (
        <div
            className="flex flex-col items-center min-h-screen p-4 bg-[#0a0502] text-[#e5e7eb] font-sans overflow-y-auto overflow-x-hidden">
            ...
            >
                ...
                <div className="text-left space-y-4">
                    ...
                    <h1 className="text-5xl font-black tracking-tighter uppercase sm:text-6xl italic leading-[0.8] mb-2 flex justify-center items-center">
                        {title.split(' ')[0]} <br/>
                ...
                <div className="space-y-4">
                    <div className="flex items-center justify-between px-2">
                        <h3 className="text-[10px] font-black uppercase tracking-widest text-gray-600">Настройка
                            группы</h3>
                        <span
                            className="text-[10px] text-gray-600 bg-white/5 px-3 py-1 rounded-full border border-white/5">{names.length} / {maxPlayers}</span>
                    </div>
                ...
                <div
                    className="grid grid-cols-2 gap-3 fixed bottom-6 left-6 right-6 max-w-md mx-auto sm:relative sm:bottom-0 sm:left-0 sm:right-0">
                    <motion.button
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-4 max-h-[60vh] overflow-y-auto pr-2 custom-scrollbar">
                                    {instructions.map((item, idx) => (
                                        <div key={idx}
                                             className="p-5 bg-white/5 rounded-3xl border border-white/5 space-y-2">
