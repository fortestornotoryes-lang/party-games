            ...
            {modes.length > 0 && setMode && (
                <div>
                    <div className="flex items-center gap-3 mb-6 px-1">
                        ...
                        <span
                            className="text-[10px] font-black uppercase tracking-[0.4em] text-white/80">{modeLabel}</span>
                    </div>
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="flex-1">
                                        <div
                                            className="text-[17px] font-black italic uppercase tracking-tight mb-1 text-white opacity-90">{m.name}</div>
                                        <div
                                            className="text-[12px] font-medium leading-tight opacity-60 italic">{m.description}</div>
                                    </div>
                                </motion.button>
                            );
                        })}
