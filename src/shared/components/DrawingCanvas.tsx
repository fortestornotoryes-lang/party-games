    ...
    return (
        <div className="flex-1 flex flex-col min-h-0 p-3 gap-2">
          ...
          >
            ...
            <div
                className="flex-1 relative min-h-0 bg-[#120a0a] rounded-premium-md border border-white/10 overflow-hidden shadow-2xl">
                <canvas
                    ref={canvasRef}
            ...
            <div
                className="flex-shrink-0 bg-black/70  border border-white/10 rounded-premium-md px-3 py-2.5 flex flex-col gap-2">
