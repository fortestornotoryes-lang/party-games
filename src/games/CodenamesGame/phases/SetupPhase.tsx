...
export const SetupPhase: React.FC<SetupPhaseProps> = ({redCaptain, blueCaptain, redTeam, blueTeam, onPlay}) => {
    ...
    return (
        ...
        >
            <Typography.Title className="text-2xl font-black text-center mb-6 uppercase tracking-widest" color="green">
                {t('common.teams')}
            </Typography.Title>
            ...
            <div className="flex flex-col justify-center gap-4">
                <div className="p-4 bg-premium-red/10 text-center border border-premium-red/30 rounded-2xl">
                    ...
                    <p className="font-bold border-b border-premium-red/20 pb-2 mb-2">
                        <span className="text-xs text-premium-red/50 uppercase block">{t('codenames.captain')}</span>
                        {redCaptain}
                    </p>
                ...
                <div className="p-4 bg-premium-blue/10 text-center border border-premium-blue/30 rounded-2xl">
                    ...
                    <p className="font-bold border-b border-premium-blue/20 pb-2 mb-2">
                        <span className="text-xs text-premium-blue/50 uppercase block">{t('codenames.captain')}</span>
                        {blueCaptain}
                    </p>
