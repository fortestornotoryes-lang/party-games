...
export const CaptainPhase: React.FC<CaptainPhaseProps> = ({
    cards, turn, currentCaptain, clueWord, clueCount, onClueWordChange, onClueCountChange, onSubmit,
}) => {
    ...
    return (
        ...
        >
            <div className="text-center">
                <p className={`text-[20px] font-black uppercase tracking-widest ${turn === 'red' ? 'text-premium-red' : 'text-premium-blue'}`}>
            ...
            <div className="grid grid-cols-5 gap-1.5 mb-4">
                {cards.map(card => (
                    <div
                        ...
                        `}
                    >
                        <span className="text-[9px] font-bold leading-tight wrap-break-word uppercase">{card.word}</span>
