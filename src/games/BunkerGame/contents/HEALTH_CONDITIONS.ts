...
export const HEALTH_CONDITIONS: AttributeEntry[] = [
  ...
  {
    name: 'Мастер дыхательных практик',
    emoji: '🫁',
  ...
  {
    name: 'Превосходное ночное зрение',
    emoji: '🦉',
    bonus: { energy: 6, morale: 4 },
    isPositive: true,
  },
  ...
  {
    name: 'Устойчивость к морской болезни',
    emoji: '🤢',
    bonus: { energy: 5, morale: 5 },
    isPositive: true,
  },
  ...
  {
    name: 'Устойчивый гормональный фон',
    emoji: '⚖️',
    bonus: { morale: 8, energy: 4 },
    isPositive: true,
  },
  {
    name: 'Здоровая кожа (без инфекций)',
    emoji: '🧼',
    bonus: { medicine: 6, morale: 2 },
    isPositive: true,
  },
  { name: 'Высокий тонус сосудов', emoji: '📈', bonus: { energy: 8 }, isPositive: true },
  {
    name: 'Отличная терморегуляция организма',
    emoji: '❄️',
    bonus: { energy: 8, water: 4 },
    isPositive: true,
  },
  { name: 'Устойчивость к аллергенам', emoji: '🌿', bonus: { medicine: 8 }, isPositive: true },
  {
    name: 'Здоровая микрофлора кишечника',
    emoji: '🥛',
    bonus: { food: 8, morale: 2 },
    isPositive: true,
  },
  {
    name: 'Высокая скорость лимфотока',
    emoji: '💧',
    bonus: { medicine: 6, energy: 4 },
    isPositive: true,
  },
  { name: 'Крепкие кости', emoji: '🦴', bonus: { energy: 7 }, isPositive: true },
  {
    name: 'Отсутствие хронических болезней',
    emoji: '🛡️',
    bonus: { medicine: 10, morale: 4 },
    isPositive: true,
  },
  {
    name: 'Быстрая акклиматизация',
    emoji: '🌍',
    bonus: { energy: 6, morale: 4 },
    isPositive: true,
  },
  ...
  {
    name: 'Хорошее периферическое зрение',
    emoji: '🕶️',
    bonus: { energy: 5, morale: 3 },
    isPositive: true,
  },
  {
    name: 'Общий высокий жизненный потенциал',
    emoji: '🔥',
  ...
  {
    name: 'Обмороки при стрессе',
    emoji: '😵',
    bonus: { morale: -12, energy: -12 },
    isPositive: false,
  },
  {
    name: 'Перелом позвоночника в прошлом',
    emoji: '🩻',
    bonus: { energy: -12 },
    isPositive: false,
  },
  ...
  },
  {
    ...
    emoji: '🥛',
    bonus: { food: -14, morale: -4 },
    isPositive: false,
  },
  {
    name: 'Глухота на одно ухо',
    emoji: '👂',
    bonus: { morale: -10, energy: -10 },
    isPositive: false,
  },
];
