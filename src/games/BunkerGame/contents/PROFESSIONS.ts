...
export const PROFESSIONS: AttributeEntry[] = [
  ...
  { name: 'Кинолог', emoji: '🐕‍🦺', tier: 'B', bonus: { morale: 8, food: 5 }, isPositive: true },
  {
    ...
    emoji: '✈️',
    tier: 'B',
    bonus: { morale: 8, energy: 6 },
    isPositive: true,
  },
  {
    name: 'Диспетчер авиасообщения',
    emoji: '🎧',
    tier: 'B',
    bonus: { morale: 8, energy: 6 },
    isPositive: true,
  ...
  },
  {
    ...
    emoji: '🚀',
    tier: 'S',
    bonus: { energy: 18, morale: 8, water: 4 },
    isPositive: true,
  },
  {
    name: 'Астрофизик',
  ...
  {
    name: 'Селекционер растений',
    emoji: '🌿',
    tier: 'A',
    bonus: { food: 18, water: 4 },
    isPositive: true,
  },
  {
  ...
  {
    name: 'Менеджер по холодным звонкам',
    emoji: '📞',
    tier: 'C',
    bonus: { morale: -15, energy: -4 },
    isPositive: false,
  },
  {
    name: 'Фасовщик угля',
    emoji: '🪵',
    tier: 'C',
    bonus: { medicine: -8, energy: -6 },
    isPositive: false,
  },
  {
    name: 'Уборщик химотходов',
    emoji: '☣️',
    tier: 'C',
    bonus: { medicine: -14 },
    isPositive: false,
  },
  {
    ...
    emoji: '🍿',
    tier: 'C',
    bonus: { energy: -10, food: -4 },
    isPositive: false,
  },
  {
    name: 'Бухгалтер в период отчетов',
    emoji: '📊',
    tier: 'C',
    bonus: { morale: -14, energy: -8 },
    isPositive: false,
  },
  {
    name: 'Дворник в метель',
    emoji: '🧹',
    tier: 'C',
    bonus: { energy: -15, water: -4 },
    isPositive: false,
  },
  {
    name: 'Профессиональный геймер',
    emoji: '🎮',
    tier: 'C',
    bonus: { energy: -12, medicine: -6 },
    isPositive: false,
  },
  {
    name: 'Копирайтер на бирже',
    emoji: '⌨️',
    tier: 'C',
  ...
  {
    name: 'Курьер службы доставки',
    emoji: '🚴',
    tier: 'C',
    bonus: { energy: -14, food: -5 },
    isPositive: false,
  },
  {
    name: 'Тестировщик матрасов',
    emoji: '🛌',
    tier: 'C',
    bonus: { energy: -18, morale: -4 },
    isPositive: false,
  },
  {
  ...
  {
    name: 'Оператор конвейера',
    emoji: '🏭',
    tier: 'C',
    bonus: { morale: -12, energy: -6 },
    isPositive: false,
  },
  ...
  {
    name: 'Ассистент фокусника',
    emoji: '🐇',
    tier: 'C',
    bonus: { energy: -8, morale: -4 },
    isPositive: false,
  },
  {
    name: 'Дегустатор дешевого алкоголя',
    emoji: '🍾',
    tier: 'C',
    bonus: { medicine: -12, water: -8 },
    isPositive: false,
  },
];
