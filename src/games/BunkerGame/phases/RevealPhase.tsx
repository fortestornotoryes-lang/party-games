        ...
        <div className="space-y-2">
          {characters.map((char, idx) => {
            ...
            return (
              ...
              >
                <div
                  className="rounded-premium-sm flex h-10 w-10 shrink-0 items-center justify-center text-xl"
                  style={{
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div
                    className="text-micro mt-0.5 font-bold tracking-widest uppercase"
                ...
                {!revealed.entry.isPositive && (
                  <span className="text-premium-red/60 flex-shrink-0 text-xs">⚠</span>
                )}
              </motion.div>
            );
          })}
