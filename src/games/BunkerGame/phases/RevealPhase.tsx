...
export const RevealPhase: React.FC<RevealPhaseProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Pass-phone card */}
      <div
        className="rounded-premium-md p-5 text-center space-y-2 flex flex-col gap-2"
        style={{
      ...
      <AnimatePresence mode="wait">
        {!isRevealed ? (
          ...
          <motion.button
            ...
            className="w-full rounded-premium-md p-8 text-center space-y-3 active:scale-[0.98] transition-transform"
            style={{
          ...
          <motion.div
            ...
            className="rounded-premium-md p-6 text-center space-y-4"
            style={{
