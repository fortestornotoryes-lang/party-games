    ...
    >
      ...
      <div className="flex items-center gap-3 px-3 pt-3 pb-2">
        ...
        <div className="min-w-0 flex-1">
          <div className="truncate text-sm font-black" style={{ color: nameColor }}>
            {char.playerName}
          </div>
          <div className="text-tag truncate text-white/35">
        ...
        {ALL_TRAIT_ROWS.map(({ key, label }) => {
          ...
          return (
            ...
            >
              ...
              {!isRevealed && (
                <span
                  className="text-tag flex-shrink-0 rounded px-1.5 py-0.5"
                  style={{
                    color: '#FF8A1F',
  ...
  return (
    ...
    >
      ...
      <div className="mt-auto pt-2">
        <PrimaryButton onClick={onContinue}>{t(`${NS.BUNKER}.toSurvivalBtn`)}</PrimaryButton>
      </div>
    </motion.div>
  );
};
