  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-center gap-2">
        <Siren className="text-premium-orange h-5 w-5 animate-pulse" />
      ...
      <motion.div
        ...
        className="rounded-premium-md relative overflow-hidden"
        style={{
          background:
      ...
      >
        ...
        <div className="relative space-y-4 overflow-y-auto p-7 text-center">
          {/* Emoji */}
      ...
      >
        ...
        <div className="mt-3 flex flex-wrap gap-1.5">
          {Array.from({ length: playerCount }).map((_, i) => (
            <div
              key={i}
              className={`h-2 min-w-[18px] flex-1 rounded-full transition-all ${
