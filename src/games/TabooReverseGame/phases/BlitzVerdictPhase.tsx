    ...
    return (
        ...
        >
          ...
          <span className="text-sm font-black text-premium-green">
                    ...
                    {results.map((result, idx) => {
                        if (result.status === 'skipped') {
                            return (
                                <div
                                    key={idx}
                                    className="p-4 rounded-premium-md border border-premium-red/20 bg-premium-red/5 flex items-center gap-3"
                                >
                        ...
                        return (
                            <div
                                key={idx}
                                className="p-4 rounded-premium-md border border-premium-green/20 bg-premium-green/5 space-y-3"
                            >
            ...
            <button
                onClick={onStopGame}
                className="w-full p-3.5 bg-white/5 border border-white/10 rounded-premium-md flex items-center justify-center gap-2 active:scale-95 transition-all"
            >
