...
export const PassPhase: React.FC<PassPhaseProps> = ({ psychic, onReady }) => {
  ...
  return (
    <motion.div
      ...
      className="flex h-full flex-col items-center justify-center space-y-10 text-center"
    >
      ...
      <div className="bg-premium-purple/5 border-premium-purple/10 rounded-premium-3xl max-w-xs border-2 p-8 transition-all">
