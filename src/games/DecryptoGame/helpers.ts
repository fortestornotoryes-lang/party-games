...
export const tBadge = (c: TeamColor) =>
    c === 'red' ? 'bg-premium-red/20 text-premium-red' : 'bg-premium-blue/20 text-premium-blue';
export const tFocus = (c: TeamColor) =>
    c === 'red' ? 'focus:border-premium-red/50' : 'focus:border-premium-blue/50';
export const tGlow = (c: TeamColor) =>
    c === 'red'
