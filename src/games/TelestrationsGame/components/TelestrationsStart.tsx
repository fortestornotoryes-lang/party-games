    ...
    return (
        ...
        >
            <div className="text-center space-y-3">
                ...
                <p className="text-white/30 text-sm">{t(`${NS.TELESTRATIONS}.rememberAndDraw`)}</p>
            </div>
            ...
            {!wordRevealed ? (
                ...
                >
                    ...
                    <div
                        className="flex items-center justify-center gap-2 text-premium-orange/50 group-hover:text-premium-orange transition-colors">
                ...
                <div
                    className="w-full max-w-sm p-8 bg-premium-orange/10 border border-premium-orange/30 rounded-premium-3xl text-center">
