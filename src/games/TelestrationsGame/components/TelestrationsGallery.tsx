        ...
        >
            <div className="p-6 space-y-6 pb-40">
                <div className="text-center space-y-1">
                    <h3 className="text-3xl font-black italic uppercase tracking-tighter">{t(`${NS.TELESTRATIONS}.chainEnd`)}</h3>
                    <p className="text-white/30 text-sm">{t(`${NS.TELESTRATIONS}.seeHowWordChanged`)}</p>
                </div>
