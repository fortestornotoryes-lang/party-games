...
export const CATASTROPHE_SCENARIOS: CatastropheScenario[] = [
    ...
    },
    {
        ...
        resourcePenalty: {energy: -125, morale: -10},
    },
    {
    ...
    },
    {
        ...
        resourcePenalty: {energy: -125, food: -10},
    },
    {
    ...
    },
    {
        ...
        resourcePenalty: {energy: -130, morale: -25},
    },
    {
    ...
    },
    {
        ...
        resourcePenalty: {energy: -125, morale: -20},
    },
    {
...
const PROFESSIONS: AttributeEntry[] = [
    ...
    {name: 'Банкир', emoji: '🏦', tier: 'C', bonus: {morale: 2}, isPositive: false},
...
const HEALTH_CONDITIONS: AttributeEntry[] = [
    ...
    {name: 'Бессонница', emoji: '🌙', bonus: {energy: -29}, isPositive: false},
    {name: 'Хроническая мигрень', emoji: '🤕', bonus: {morale: -18, energy: -25}, isPositive: false},
    {name: 'Плохое зрение', emoji: '👓', bonus: {energy: -24}, isPositive: false},
    {name: 'Глухота', emoji: '🦻', bonus: {morale: -18}, isPositive: false},
    {name: 'Частичная потеря зрения', emoji: '🩹', bonus: {energy: -28}, isPositive: false},
    {name: 'Проблемы со спиной', emoji: '🦴', bonus: {energy: -29}, isPositive: false},
    {name: 'Гастрит', emoji: '🍽️', bonus: {food: -8}, isPositive: false},
    {name: 'Хроническая усталость', emoji: '😪', bonus: {energy: -12}, isPositive: false},
    {name: 'Подагра', emoji: '🦶', bonus: {energy: -26}, isPositive: false},
    {name: 'Тахикардия', emoji: '💓', bonus: {energy: -26, medicine: -4}, isPositive: false},
    {name: 'Аритмия', emoji: '❤️‍🩹', bonus: {energy: -25, medicine: -5}, isPositive: false},
    {name: 'Плохие зубы', emoji: '🦷', bonus: {morale: -14, medicine: -4}, isPositive: false},
    {name: 'Протез ноги', emoji: '🦿', bonus: {energy: -29}, isPositive: false},
    {name: 'Протез руки', emoji: '🦾', bonus: {energy: -28}, isPositive: false},
    {name: 'Плохой слух', emoji: '👂', bonus: {morale: -14}, isPositive: false},
    ...
    {name: 'Проблемы со щитовидкой', emoji: '🩺', bonus: {energy: -26}, isPositive: false},
    {name: 'Плоскостопие', emoji: '🦶', bonus: {energy: -24}, isPositive: false},
    {name: 'Заикание', emoji: '🗣️', bonus: {morale: -25}, isPositive: false},
    {name: 'Хронический гайморит', emoji: '🤧', bonus: {medicine: -4}, isPositive: false},
    {name: 'Слабые лёгкие', emoji: '🫁', bonus: {energy: -28}, isPositive: false},
    {name: 'Катаракта', emoji: '👁️', bonus: {energy: -26}, isPositive: false},
    {name: 'Синдром раздражённого кишечника', emoji: '🥴', bonus: {food: -6}, isPositive: false},
    {name: 'Повышенная тревожность', emoji: '😟', bonus: {morale: -18}, isPositive: false},
    ...
    {name: 'Проблемы с печенью', emoji: '🫀', bonus: {medicine: -8}, isPositive: false},
    {name: 'Хронический отит', emoji: '👂', bonus: {morale: -14}, isPositive: false},
    {name: 'Дальнозоркость', emoji: '🔍', bonus: {energy: -13}, isPositive: false},
    {name: 'Низкая выносливость', emoji: '😮‍💨', bonus: {energy: -29}, isPositive: false},
    ...
    {name: 'Гипермобильность суставов', emoji: '🤸', bonus: {energy: -24}, isPositive: false},
    {name: 'Обмороки при стрессе', emoji: '😵', bonus: {morale: -18, energy: -26}, isPositive: false},
    ...
    {name: 'Сахарный диабет', emoji: '💉', bonus: {food: -10, medicine: -8}, isPositive: false},
    {
        ...
        emoji: '❤️‍🩹',
        bonus: {medicine: -15, morale: -25},
        isPositive: false,
    },
    {name: 'Депрессия', emoji: '😔', bonus: {morale: -15, energy: -25}, isPositive: false},
    {
    ...
    {name: 'Ожирение 2 степени', emoji: '🍔', bonus: {food: -12, energy: -25}, isPositive: false},
    {name: 'Небольшая близорукость', emoji: '👓', bonus: {morale: -13}, isPositive: false},
    {
        name: 'Онкология в ремиссии',
        emoji: '🎗️',
        bonus: {medicine: -12, morale: -25},
        isPositive: false,
    },
    {
        name: 'Хронический бронхит',
        emoji: '🫁',
        bonus: {energy: -28, medicine: -5},
        isPositive: false,
    },
    {name: 'Аллергия на пыль', emoji: '🤧', bonus: {energy: -25, morale: -13}, isPositive: false},
    {name: 'ВИЧ-позитивный', emoji: '🩸', bonus: {medicine: -15, morale: -25}, isPositive: false},
    {
        name: 'Беременность',
        emoji: '🤱',
    ...
    {name: 'Высокий болевой порог', emoji: '🪨', bonus: {morale: 8, energy: 5}, isPositive: true},
    {
        ...
        emoji: '🦠',
        bonus: {medicine: -12, morale: -14},
        isPositive: false,
    },
    {name: 'Гипертония', emoji: '📈', bonus: {medicine: -8, energy: -26}, isPositive: false},
    {name: 'Анемия', emoji: '🩸', bonus: {energy: -29, morale: -14}, isPositive: false},
    {name: 'Артрит', emoji: '🦴', bonus: {energy: -28, food: -3}, isPositive: false},
    {name: 'Язва желудка', emoji: '🥴', bonus: {food: -10, morale: -14}, isPositive: false},
    {name: 'Панические атаки', emoji: '😨', bonus: {morale: -12, energy: -25}, isPositive: false},
    {name: 'Социофобия', emoji: '🙈', bonus: {morale: -10}, isPositive: false},
    {name: 'ПТСР', emoji: '🎇', bonus: {morale: -10, energy: -26}, isPositive: false},
    {name: 'Эпилепсия', emoji: '⚠️', bonus: {medicine: -10, energy: -25}, isPositive: false},
    {name: 'Тремор рук', emoji: '✋', bonus: {medicine: -6, energy: -24}, isPositive: false},
    {name: 'Сколиоз', emoji: '🧍', bonus: {energy: -27, morale: -13}, isPositive: false},
    {name: 'Дальтонизм', emoji: '🎨', bonus: {morale: -2}, isPositive: false},
    {name: 'Старые травмы колена', emoji: '🦵', bonus: {energy: -28}, isPositive: false},
    {
...
const HOBBIES: AttributeEntry[] = [
    {name: 'Кузнечное дело', emoji: '⚒️', bonus: {energy: 10, morale: 3}, isPositive: true},
    {name: 'Электроника', emoji: '🔌', bonus: {energy: 12}, isPositive: true},
    {name: '3D-моделирование', emoji: '🖥️', bonus: {energy: 6, morale: 4}, isPositive: true},
    {name: 'Программирование', emoji: '💻', bonus: {energy: 8}, isPositive: true},
    {name: 'Робототехника', emoji: '🤖', bonus: {energy: 10}, isPositive: true},
    {name: 'Археология', emoji: '🏺', bonus: {food: 4, morale: 6}, isPositive: true},
    {name: 'Геокешинг', emoji: '📍', bonus: {food: 6, water: 6}, isPositive: true},
    {name: 'Туризм', emoji: '🎒', bonus: {energy: 8, morale: 5}, isPositive: true},
    {name: 'Спелеология', emoji: '🕳️', bonus: {water: 8, energy: 5}, isPositive: true},
    {name: 'Парусный спорт', emoji: '⛵', bonus: {water: 10}, isPositive: true},
    {name: 'Гребля', emoji: '🚣', bonus: {energy: 8, water: 4}, isPositive: true},
    {name: 'Лыжный спорт', emoji: '🎿', bonus: {energy: 10}, isPositive: true},
    {name: 'Паркур', emoji: '🏃', bonus: {energy: 2}, isPositive: true},
    {name: 'Фехтование', emoji: '🤺', bonus: {energy: 8, morale: 4}, isPositive: true},
    {name: 'Стрельба из лука', emoji: '🏹', bonus: {food: 6, energy: 4}, isPositive: true},
    {name: 'Шахматы', emoji: '♟️', bonus: {morale: 8, energy: 3}, isPositive: true},
    {name: 'Настольные игры', emoji: '🎲', bonus: {morale: 10}, isPositive: true},
    {name: 'Решение головоломок', emoji: '🧩', bonus: {morale: 8, energy: 4}, isPositive: true},
    {name: 'Каллиграфия', emoji: '✒️', bonus: {morale: 7}, isPositive: true},
    {name: 'Поэзия', emoji: '📜', bonus: {morale: 8}, isPositive: true},
    {name: 'Написание рассказов', emoji: '📚', bonus: {morale: 8}, isPositive: true},
    {name: 'Ведение дневника', emoji: '📔', bonus: {morale: 7}, isPositive: true},
    {name: 'Рисование', emoji: '🎨', bonus: {morale: 10}, isPositive: true},
    {name: 'Скульптура', emoji: '🗿', bonus: {morale: 8, energy: 3}, isPositive: true},
    {name: 'Гончарное дело', emoji: '🏺', bonus: {water: 4, morale: 6}, isPositive: true},
    {name: 'Вязание', emoji: '🧶', bonus: {morale: 8, medicine: 3}, isPositive: true},
    {name: 'Макраме', emoji: '🪢', bonus: {morale: 6, energy: 3}, isPositive: true},
    {name: 'Изготовление свечей', emoji: '🕯️', bonus: {morale: 8, energy: 3}, isPositive: true},
    {name: 'Мыловарение', emoji: '🧼', bonus: {medicine: 8}, isPositive: true},
    {name: 'Кожевенное дело', emoji: '👜', bonus: {energy: 7, morale: 3}, isPositive: true},
    {name: 'Таксидермия', emoji: '🦌', bonus: {food: 5, morale: 3}, isPositive: true},
    {name: 'Собирательство грибов', emoji: '🍄', bonus: {food: 10}, isPositive: true},
    {name: 'Собирательство ягод', emoji: '🫐', bonus: {food: 8}, isPositive: true},
    {name: 'Выращивание специй', emoji: '🌶️', bonus: {food: 8, morale: 4}, isPositive: true},
    {name: 'Аквариумистика', emoji: '🐠', bonus: {morale: 7, water: 3}, isPositive: true},
    {name: 'Разведение птиц', emoji: '🐔', bonus: {food: 8}, isPositive: true},
    {name: 'Дрессировка животных', emoji: '🐕', bonus: {morale: 8, food: 3}, isPositive: true},
    {name: 'Коневодство', emoji: '🐎', bonus: {energy: 8, morale: 4}, isPositive: true},
    {name: 'Следопытство', emoji: '👣', bonus: {food: 8, water: 4}, isPositive: true},
    {name: 'Ориентирование на местности', emoji: '🧭', bonus: {energy: 8, water: 4}, isPositive: true},
    {name: 'Радиоконструирование', emoji: '📻', bonus: {energy: 10}, isPositive: true},
    {name: 'Сборка дронов', emoji: '🚁', bonus: {energy: 10, morale: 4}, isPositive: true},
    {name: 'Авиамоделизм', emoji: '🛩️', bonus: {energy: 8, morale: 4}, isPositive: true},
    {name: 'Судомоделизм', emoji: '🚢', bonus: {water: 5, morale: 5}, isPositive: true},
    {name: 'Металлоискательство', emoji: '🔍', bonus: {food: 4, energy: 5}, isPositive: true},
    {name: 'Реставрация вещей', emoji: '🛠️', bonus: {energy: 10}, isPositive: true},
    {name: 'Замочное дело', emoji: '🔐', bonus: {energy: 8, morale: 3}, isPositive: true},
    {name: 'Пирография (выжигание)', emoji: '🔥', bonus: {morale: 7, energy: 3}, isPositive: true},
    {name: 'Фокусничество', emoji: '🎩', bonus: {morale: 12}, isPositive: true},
    {name: 'Организация праздников', emoji: '🎊', bonus: {morale: 14}, isPositive: true},
...
const PHOBIAS: AttributeEntry[] = [
    {name: 'Клаустрофобия', emoji: '😱', bonus: {morale: -20, energy: -25}, isPositive: false},
    {name: 'Боязнь темноты', emoji: '🌑', bonus: {morale: -12, energy: -25}, isPositive: false},
    {
    ...
    {name: 'Панические атаки', emoji: '💨', bonus: {morale: -12, energy: -25}, isPositive: false},
    {
        ...
        emoji: '🔥',
        bonus: {morale: -18, energy: -25},
        isPositive: false,
    },
    {name: 'Боязнь крови', emoji: '🩸', bonus: {medicine: -8, morale: -25}, isPositive: false},
    {name: 'Паранойя', emoji: '🔍', bonus: {morale: -10, energy: -25}, isPositive: false},
    {name: 'Арахнофобия', emoji: '🕷️', bonus: {morale: -25}, isPositive: false},
    {name: 'Агорафобия', emoji: '🏙️', bonus: {morale: -12, energy: -25}, isPositive: false},
    {name: 'Аквафобия', emoji: '🌊', bonus: {water: -8, morale: -25}, isPositive: false},
    {
        name: 'Акрофобия (страх высоты)',
        emoji: '🏔️',
        bonus: {energy: -28, morale: -25},
        isPositive: false,
    },
    {
        name: 'Никтофобия (страх ночи)',
        emoji: '🌌',
        bonus: {morale: -10, energy: -24},
        isPositive: false,
    },
    {name: 'Танатофобия (страх смерти)', emoji: '⚰️', bonus: {morale: -12}, isPositive: false},
    {
        ...
        emoji: '🩹',
        bonus: {medicine: -8, morale: -14},
        isPositive: false,
    },
    {
        name: 'Аэрофобия (страх шума сирен и полёта)',
        emoji: '✈️',
        bonus: {morale: -18, energy: -24},
        isPositive: false,
    },
    {name: 'Зоофобия', emoji: '🐺', bonus: {food: -5, morale: -25}, isPositive: false},
    ...
    {name: 'Гермофобия', emoji: '🧼', bonus: {morale: -18, medicine: -4}, isPositive: false},
    {
        name: 'Кинофобия (страх собак)',
        emoji: '🐕',
        bonus: {morale: -16, food: -14},
        isPositive: false,
    },
    {name: 'Офидиофобия (страх змей)', emoji: '🐍', bonus: {morale: -16}, isPositive: false},
    {
        name: 'Эметофобия (страх рвоты и тошноты)',
        emoji: '🤢',
        bonus: {medicine: -6, morale: -25},
        isPositive: false,
    },
    {
        name: 'Астрафобия (страх грома)',
        emoji: '⛈️',
        bonus: {morale: -18, energy: -13},
        isPositive: false,
    },
    {name: 'Технофобия', emoji: '📟', bonus: {energy: -29}, isPositive: false},
    {
    ...
    },
    {
        ...
        name: 'Гидрофобия (страх глубокой воды)',
        emoji: '🌊',
        bonus: {water: -10, morale: -14},
        isPositive: false,
    },
    {
        name: 'Дентофобия (страх стоматологов)',
        emoji: '🦷',
        bonus: {medicine: -8},
        isPositive: false,
    },
    {
        name: 'Коулрофобия (страх клоунов)',
        emoji: '🤡',
        bonus: {morale: -25},
        isPositive: false,
    },
    {
        name: 'Амаксофобия (страх транспорта)',
        emoji: '🚗',
        bonus: {energy: -26},
        isPositive: false,
    },
    {
        name: 'Киберфобия (страх компьютеров)',
        emoji: '💻',
        bonus: {energy: -28},
        isPositive: false,
    },
    {
        name: 'Гоплофобия (страх оружия)',
        emoji: '🔫',
        bonus: {morale: -18, energy: -24},
        isPositive: false,
    },
    {
        name: 'Хемофобия (страх химикатов)',
        emoji: '☣️',
        bonus: {medicine: -6, energy: -24},
        isPositive: false,
    },
    {
        name: 'Фонофобия (страх громких звуков)',
        emoji: '🔊',
        bonus: {morale: -10},
        isPositive: false,
    },
    {
        name: 'Скоптофобия (страх осуждения)',
        emoji: '👀',
        bonus: {morale: -12},
        isPositive: false,
    },
    {
        name: 'Ксенофобия (страх незнакомцев)',
        emoji: '🚷',
        bonus: {morale: -10},
        isPositive: false,
    },
    ...
    {
        name: 'Энтомофобия (страх насекомых)',
        emoji: '🪲',
        bonus: {morale: -16},
        isPositive: false,
    },
    {
        name: 'Мусофобия (страх мышей)',
        emoji: '🐭',
        bonus: {food: -14, morale: -25},
        isPositive: false,
    },
    {
        name: 'Орнитофобия (страх птиц)',
        emoji: '🦅',
        bonus: {morale: -14},
        isPositive: false,
    },
    {
        name: 'Батрахофобия (страх лягушек)',
        emoji: '🐸',
        bonus: {morale: -13},
        isPositive: false,
    },
    {
        name: 'Ихтиофобия (страх рыбы)',
        emoji: '🐟',
        bonus: {food: -6},
        isPositive: false,
    },
    ...
    {
        name: 'Нозофобия (страх болезней)',
        emoji: '🤒',
        bonus: {medicine: -8, morale: -14},
        isPositive: false,
    },
    {
        name: 'Фармакофобия (страх лекарств)',
        emoji: '💊',
        bonus: {medicine: -12},
        isPositive: false,
    },
    {
        name: 'Токсикофобия (страх отравления)',
        emoji: '☠️',
        bonus: {food: -5, water: -5},
        isPositive: false,
    },
    {
        name: 'Электрофобия (страх электричества)',
        emoji: '⚡',
        bonus: {energy: -12},
        isPositive: false,
    },
    ...
    {
        name: 'Гелиофобия (страх солнечного света)',
        emoji: '☀️',
        bonus: {morale: -16},
        isPositive: false,
    },
    {
        name: 'Селенофобия (страх луны)',
        emoji: '🌕',
        bonus: {morale: -25},
        isPositive: false,
    },
    {
        name: 'Хронофобия (страх течения времени)',
        emoji: '⏳',
        bonus: {morale: -10},
        isPositive: false,
    },
    {
        name: 'Гефирофобия (страх мостов)',
        emoji: '🌉',
        bonus: {energy: -24},
        isPositive: false,
    },
    {
        name: 'Талассофобия (страх океана)',
        emoji: '🌊',
        bonus: {water: -6, morale: -25},
        isPositive: false,
    },
    {
        name: 'Лимнофобия (страх озёр)',
        emoji: '🏞️',
        bonus: {water: -5},
        isPositive: false,
    },
    {
        name: 'Дендрофобия (страх деревьев)',
        emoji: '🌳',
        bonus: {food: -14},
        isPositive: false,
    },
    {
        name: 'Антрофобия (страх людей)',
        emoji: '🧍',
        bonus: {morale: -15},
        isPositive: false,
    },
    {
        name: 'Гинофобия (страх женщин)',
        emoji: '👩',
        bonus: {morale: -18},
        isPositive: false,
    },
    {
        name: 'Андрофобия (страх мужчин)',
        emoji: '👨',
        bonus: {morale: -18},
        isPositive: false,
    },
    ...
    {
        name: 'Педиофобия (страх кукол)',
        emoji: '🪆',
        bonus: {morale: -25},
        isPositive: false,
    },
    {
        name: 'Автофобия (страх одиночества)',
        emoji: '🚪',
        bonus: {morale: -12},
        isPositive: false,
    },
    {
        name: 'Гипнофобия (страх сна)',
        emoji: '😴',
        bonus: {energy: -29},
        isPositive: false,
    },
    {
        name: 'Омброфобия (страх дождя)',
        emoji: '🌧️',
        bonus: {water: -4},
        isPositive: false,
    },
    {
        name: 'Криофобия (страх холода)',
        emoji: '❄️',
        bonus: {energy: -26},
        isPositive: false,
    },
    {
        name: 'Термофобия (страх жары)',
        emoji: '🥵',
        bonus: {water: -6},
        isPositive: false,
    },
    {
        name: 'Демонофобия (страх сверхъестественного)',
        emoji: '👻',
        bonus: {morale: -18},
        isPositive: false,
    },
    {
        name: 'Нумерофобия (страх цифр и расчётов)',
        emoji: '🔢',
        bonus: {energy: -24, morale: -14},
        isPositive: false,
    },
    {
        name: 'Логофобия (страх слов и разговоров)',
        emoji: '🗣️',
        bonus: {morale: -10},
        isPositive: false,
    },
    {
        name: 'Гелиофобия (страх яркого света)',
        emoji: '💡',
        bonus: {energy: -25, morale: -25},
        isPositive: false,
    },

    {
        name: 'Ателофобия (страх совершить ошибку)',
        emoji: '❌',
        bonus: {morale: -10},
        isPositive: false,
    },
    {
        name: 'Какоррафиофобия (страх неудачи)',
        emoji: '📉',
        bonus: {morale: -12},
        isPositive: false,
    },
    {
        name: 'Фобофобия (страх собственных страхов)',
        emoji: '😨',
        bonus: {morale: -15},
        isPositive: false,
    },
    {
        name: 'Кенофобия (страх пустых помещений)',
        emoji: '🏚️',
        bonus: {morale: -7},
        isPositive: false,
    },
    {
        name: 'Сидерофобия (страх звёздного неба)',
        emoji: '✨',
        bonus: {morale: -25},
        isPositive: false,
    },
    {
        name: 'Топофобия (страх определённых мест)',
        emoji: '📍',
        bonus: {morale: -18},
        isPositive: false,
    },
    {
        name: 'Верминофобия (страх червей)',
        emoji: '🪱',
        bonus: {food: -14, morale: -14},
        isPositive: false,
    },
    {
        name: 'Трихофобия (страх волос)',
        emoji: '💇',
        bonus: {morale: -14},
        isPositive: false,
    },
    {
        name: 'Хирофобия (страх рук и прикосновений)',
        emoji: '🤝',
        bonus: {morale: -10},
        isPositive: false,
    },
    {
        name: 'Дисморфофобия (навязчивое недовольство собой)',
        emoji: '🪞',
        bonus: {morale: -12},
        isPositive: false,
    },
...
export const SURVIVAL_EVENTS: SurvivalEvent[] = [
    ...
    },
    {
        ...
        emoji: '📉',
        effect: {food: 10, water: 10, morale: -15},
        positive: false,
    },
    {
        title: 'Новый жилец',
    ...
    },
    {
        ...
        emoji: '☢️',
        effect: {energy: -29, water: -10, morale: -10},
        positive: false,
    },
];
