...
export const CATASTROPHE_SCENARIOS: CatastropheScenario[] = [
  {
    title: 'Ядерная война',
    emoji: '☢️',
    description: 'Сверхдержавы обменялись ракетными ударами. Города в руинах, радиация накрывает полушарие. Бункер рассчитан на 3 года.',
    resourcePenalty: { food: -15, water: -10 },
  },
  {
    title: 'Пандемия нового вируса',
    emoji: '🦠',
    description: 'Мутировавший патоген с летальностью 94%. Вакцина не разработана. В живых остались единицы — и они бегут к укрытиям.',
    resourcePenalty: { medicine: -20, morale: -10 },
  },
  {
    title: 'Извержение супервулкана',
    emoji: '🌋',
    description: 'Йеллоустоун проснулся. Вулканический пепел закрыл солнце на десятилетие. Температура упала на 12°C. Сельское хозяйство уничтожено.',
    resourcePenalty: { food: -20, energy: -10 },
  },
  {
    title: 'Падение астероида',
    emoji: '☄️',
    description: 'Объект диаметром 2 км столкнулся с Землёй. Ударная волна, цунами, ядерная зима. Поверхность стала непригодной для жизни.',
    resourcePenalty: { food: -15, water: -15 },
  },
  {
    title: 'Восстание ИИ',
    emoji: '🤖',
    description: 'Сеть AGI-систем вышла из-под контроля и взяла управление инфраструктурой. Электросети отключены. Дроны охотятся на выживших.',
    resourcePenalty: { energy: -25, morale: -10 },
  },
  {
    title: 'Глобальный потоп',
    emoji: '🌊',
    description: 'Антарктические ледники рухнули разом. Океан поглотил прибрежные зоны. 80% суши под водой. Питьевая вода парадоксально в дефиците.',
    resourcePenalty: { food: -20, energy: -10 },
  },
  {
    title: 'Химическая атака',
    emoji: '☣️',
    description: 'Террористы распылили нервно-паралитическое вещество VX в атмосфере. Воздух над городами смертоносен. Укрытия — единственный шанс.',
    resourcePenalty: { medicine: -20, water: -15 },
  },
  {
    title: 'Ядерная зима',
    emoji: '🌫️',
    description: 'После серии взрывов облако пыли накрыло планету. Температура упала ниже нуля даже на экваторе. Урожаи уничтожены навсегда.',
    resourcePenalty: { food: -25, energy: -10 },
  },
  {
    title: 'Магнитная буря',
    emoji: '🌐',
    description: 'Вспышка класса X42 уничтожила электронику по всему миру. Цивилизация рухнула за сутки. Хаос, мародёрство, войны за ресурсы.',
    resourcePenalty: { energy: -20, morale: -15 },
  },
  {
    title: 'Биологический теракт',
    emoji: '🧫',
    description: 'Инженерный прионный вирус распространился через водопровод. Поражает нервную систему. Противоядие не найдено.',
    resourcePenalty: { medicine: -25, water: -10 },
  },
  {
    title: 'Зомби-апокалипсис',
    emoji: '🧟',
    description: 'Кордицепс-мутант поразил 40% населения. Инфицированные агрессивны и неуправляемы. Поверхность смертельно опасна.',
    resourcePenalty: { morale: -20, food: -10 },
  },
  {
    title: 'Солнечная катастрофа',
    emoji: '🌞',
    description: 'Солнечная вспышка сожгла озоновый слой. УФ-радиация на поверхности летальна. Дневной свет — смерть.',
    resourcePenalty: { energy: -15, food: -15 },
  },
  {
    title: 'Инопланетное вторжение',
    emoji: '👽',
    description: 'Зонды-разведчики уничтожают крупные объекты. Военные бессильны. Сигнал "уйдите под землю" прозвучал по всем каналам.',
    resourcePenalty: { morale: -25, energy: -10 },
  },
  {
    title: 'Взрыв АЭС',
    emoji: '💥',
    description: 'Каскадный взрыв 12 реакторов после теракта. Европа накрыта радиоактивным облаком. Уровень радиации несовместим с жизнью на поверхности.',
    resourcePenalty: { medicine: -15, food: -15 },
  },
  {
    title: 'Нанотехнологическая катастрофа',
    emoji: '⚗️',
    description: 'Серые нанороботы вышли из лабораторий и поглощают органику. Поверхность Земли превращается в серую слизь.',
    resourcePenalty: { food: -20, medicine: -10 },
  },
  {
    title: 'Глобальная засуха',
    emoji: '🏜️',
    description: 'Осадки исчезли на годы. Реки высохли, водохранилища опустели, урожаи погибли. Вода стала дороже золота.',
    resourcePenalty: { water: -25, food: -15 },
  },
  {
    title: 'Ледниковый период',
    emoji: '🧊',
    description: 'Температура по всей планете стремительно падает. Метели не прекращаются месяцами. Выживают только те, у кого есть тепло и запасы.',
    resourcePenalty: { energy: -25, food: -10 },
  },
  {
    title: 'Глобальное землетрясение',
    emoji: '🌍',
    description: 'Серия тектонических разломов разрушила города и инфраструктуру. Тоннели обрушены, линии снабжения уничтожены.',
    resourcePenalty: { energy: -15, morale: -15 },
  },
  {
    title: 'Цепочка цунами',
    emoji: '🌊',
    description: 'Подводные разломы вызвали волну гигантских цунами. Прибрежные мегаполисы смыты, связь с внешним миром потеряна.',
    resourcePenalty: { water: -10, food: -20 },
  },
  {
    title: 'Супершторм',
    emoji: '🌪️',
    description: 'Атмосфера вошла в хаотический режим. Ураганы и торнадо возникают ежедневно, разрушая всё на поверхности.',
    resourcePenalty: { energy: -20, morale: -10 },
  },
  {
    title: 'Кислотные дожди',
    emoji: '🌧️',
    description: 'Химические выбросы превратили осадки в едкую кислоту. Открытые поверхности разрушаются, вода загрязнена.',
    resourcePenalty: { water: -20, medicine: -10 },
  },
  {
    title: 'Токсичный смог',
    emoji: '😷',
    description: 'Города укрыты плотным слоем ядовитого смога. Дыхание без фильтра смертельно, а вентиляция быстро выходит из строя.',
    resourcePenalty: { medicine: -15, energy: -15 },
  },
  {
    title: 'Коллапс экосистемы',
    emoji: '🐜',
    description: 'Массовое вымирание насекомых и растений обрушило пищевые цепочки. Фермы пусты, животные гибнут, природа мертвеет.',
    resourcePenalty: { food: -25, morale: -10 },
  },
  {
    title: 'Грибковая чума',
    emoji: '🍄',
    description: 'Агрессивный грибок заражает людей, животных и запасы пищи. Споры проникают даже в защищённые помещения.',
    resourcePenalty: { food: -15, medicine: -20 },
  },
  {
    title: 'Паразитарная инвазия',
    emoji: '🪱',
    description: 'Новый вид паразитов распространяется через воду и кровь. Болезнь развивается скрытно, а лечение почти не помогает.',
    resourcePenalty: { medicine: -20, water: -10 },
  },
  {
    title: 'Генетическая мутация',
    emoji: '🧬',
    description: 'Неудачный эксперимент изменил ДНК вирусов и людей. Рождаются нестабильные формы жизни, иммунитет человечества бесполезен.',
    resourcePenalty: { medicine: -25, morale: -10 },
  },
  {
    title: 'Побег лабораторных существ',
    emoji: '🧪',
    description: 'Из биолабораторий вырвались экспериментальные организмы. Они быстро размножаются и атакуют всё живое.',
    resourcePenalty: { morale: -20, medicine: -10 },
  },
  {
    title: 'Массовое безумие',
    emoji: '🌀',
    description: 'Неизвестный психотропный фактор вызывает агрессию, бред и саморазрушение. Никому нельзя доверять полностью.',
    resourcePenalty: { morale: -25, medicine: -10 },
  },
  {
    title: 'Гражданская война за ресурсы',
    emoji: '⚔️',
    description: 'Государства распались, вооружённые группировки делят склады и источники воды. Любой выход наружу — смертельный риск.',
    resourcePenalty: { morale: -25, food: -10 },
  },
  {
    title: 'Мировой энергетический крах',
    emoji: '🔌',
    description: 'Топливо закончилось, энергосети обрушились, резервные станции молчат. Мир откатился на столетия назад за одну неделю.',
    resourcePenalty: { energy: -30, morale: -5 },
  },
  {
    title: 'Обвал финансовой системы',
    emoji: '💸',
    description: 'Валюта и логистика потеряли смысл. Паника, мародёрство и голод уничтожили общественный порядок быстрее любой войны.',
    resourcePenalty: { food: -15, morale: -20 },
  },
  {
    title: 'Киберапокалипсис',
    emoji: '💻',
    description: 'Вредоносная сеть стерла данные, отключила спутники и взломала критическую инфраструктуру. Автоматика стала опаснее людей.',
    resourcePenalty: { energy: -20, morale: -15 },
  },
  {
    title: 'Орбитальная бомбардировка',
    emoji: '🛰️',
    description: 'Автономные военные спутники начали наносить удары по тепловым и радиосигнатурам. Любая активность на поверхности выдаёт укрытие.',
    resourcePenalty: { morale: -20, energy: -15 },
  },
  {
    title: 'Падение спутниковой сети',
    emoji: '📡',
    description: 'Тысячи спутников сошли с орбиты и вызвали цепные разрушения. Навигация, связь и разведка больше не работают.',
    resourcePenalty: { energy: -15, morale: -15 },
  },
  {
    title: 'Лунная пыль',
    emoji: '🌕',
    description: 'После аварии на орбитальном комплексе атмосферу накрыло облаком абразивной пыли. Фильтры забиваются за считаные дни.',
    resourcePenalty: { energy: -15, medicine: -15 },
  },
  {
    title: 'Разлом магнитосферы',
    emoji: '🧲',
    description: 'Защита Земли ослабла, космическое излучение проникает к поверхности. Болезни, ожоги и отказ техники стали нормой.',
    resourcePenalty: { medicine: -20, energy: -10 },
  },
  {
    title: 'Метеоритный дождь',
    emoji: '🌠',
    description: 'Рой обломков проходит через атмосферу сутками. Пожары, разрушения и пробоины делают поверхность непригодной.',
    resourcePenalty: { morale: -20, food: -10 },
  },
  {
    title: 'Чёрный снег',
    emoji: '🖤',
    description: 'Неизвестные частицы выпадают в виде тёмного снега. Они заражают воду, почву и лёгкие, постепенно убивая всё живое.',
    resourcePenalty: { water: -20, medicine: -15 },
  },
  {
    title: 'Аномалия времени',
    emoji: '⏳',
    description: 'Во многих регионах время течёт нестабильно. Люди исчезают, техника ломается, а прогнозировать последствия невозможно.',
    resourcePenalty: { morale: -20, energy: -10 },
  },
  {
    title: 'Гравитационные сбои',
    emoji: '🪐',
    description: 'Локальные всплески гравитации рушат здания и ломают механизмы. Перемещение по поверхности стало почти невозможным.',
    resourcePenalty: { morale: -20, energy: -10 },
  },
  {
    title: 'Темная материя в атмосфере',
    emoji: '🌌',
    description: 'Неизвестное космическое вещество взаимодействует с биологией и техникой. Приборы сходят с ума, а люди слабеют без причин.',
    resourcePenalty: { medicine: -15, energy: -15 },
  },
  {
    title: 'Религиозный экстремизм',
    emoji: '🔥',
    description: 'После катастрофы мир погрузился в фанатизм. Культы охотятся на выживших и уничтожают убежища «неверных».',
    resourcePenalty: { morale: -20, food: -5 },
  },
  {
    title: 'Вторжение мутировавшей фауны',
    emoji: '🐺',
    description: 'Животные изменились под воздействием среды и стали агрессивнее в десятки раз. Поверхность принадлежит новым хищникам.',
    resourcePenalty: { morale: -20, food: -10 },
  },
  {
    title: 'Океаническая инфекция',
    emoji: '🪼',
    description: 'Мировой океан заражён биолюминесцентной бактерией, выделяющей токсины. Рыба мертва, испарения отравляют побережья.',
    resourcePenalty: { water: -20, food: -15 },
  },
  {
    title: 'Исчезновение Солнца',
    emoji: '🌑',
    description: 'Светило внезапно скрылось за неизвестной космической аномалией. Темнота, холод и паника охватили планету за считаные часы.',
...
const HEALTH_CONDITIONS: AttributeEntry[] = [
  { name: 'Абсолютно здоров', emoji: '💪', bonus: { food: 5, water: 5, medicine: 5, energy: 5, morale: 5 }, isPositive: true },
  { name: 'Отличная физподготовка', emoji: '🏃', bonus: { energy: 15, morale: 5 }, isPositive: true },
  { name: 'Крепкое здоровье', emoji: '🌟', bonus: { energy: 8, morale: 8 }, isPositive: true },
  { name: 'Хроническая астма', emoji: '😤', bonus: { energy: -10, medicine: -5 }, isPositive: false },
  { name: 'Сахарный диабет', emoji: '💉', bonus: { food: -10, medicine: -8 }, isPositive: false },
  { name: 'Сердечная недостаточность', emoji: '❤️‍🩹', bonus: { medicine: -15, morale: -5 }, isPositive: false },
  { name: 'Депрессия', emoji: '😔', bonus: { morale: -15, energy: -5 }, isPositive: false },
  { name: 'Алкогольная зависимость', emoji: '🍶', bonus: { morale: -12, food: -5 }, isPositive: false },
  ...
  { name: 'Онкология в ремиссии', emoji: '🎗️', bonus: { medicine: -12, morale: -5 }, isPositive: false },
  { name: 'Хронический бронхит', emoji: '🫁', bonus: { energy: -8, medicine: -5 }, isPositive: false },
  ...
  { name: 'Беременность', emoji: '🤱', bonus: { morale: 10, food: -10, medicine: -5 }, isPositive: true },
  { name: 'Железная выносливость', emoji: '🦾', bonus: { energy: 14, food: 4 }, isPositive: true },
  { name: 'Быстрое восстановление', emoji: '✨', bonus: { medicine: 8, energy: 6, morale: 4 }, isPositive: true },
  { name: 'Высокий болевой порог', emoji: '🪨', bonus: { morale: 8, energy: 5 }, isPositive: true },
  { name: 'Слабый иммунитет', emoji: '🦠', bonus: { medicine: -12, morale: -4 }, isPositive: false },
  ...
  { name: 'Лактозная непереносимость', emoji: '🥛', bonus: { food: -4, morale: -2 }, isPositive: false },
  { name: 'Глухота на одно ухо', emoji: '👂', bonus: { morale: -4, energy: -2 }, isPositive: false },
...
const HOBBIES: AttributeEntry[] = [
  ...
  { name: 'Выживание в дикой природе', emoji: '🏕️', bonus: { food: 8, energy: 8 }, isPositive: true },
  ...
  { name: 'Сбор лекарственных трав', emoji: '🌿', bonus: { medicine: 10, food: 4 }, isPositive: true },
...
const PHOBIAS: AttributeEntry[] = [
  ...
  { name: 'Трипанофобия (страх игл)', emoji: '💉', bonus: { medicine: -10, morale: -5 }, isPositive: false },
  { name: 'Социофобия', emoji: '👥', bonus: { morale: -15 }, isPositive: false },
  { name: 'Панические атаки', emoji: '💨', bonus: { morale: -12, energy: -5 }, isPositive: false },
  { name: 'Пирофобия (страх огня)', emoji: '🔥', bonus: { morale: -8, energy: -5 }, isPositive: false },
  ...
  { name: 'Акрофобия (страх высоты)', emoji: '🏔️', bonus: { energy: -8, morale: -5 }, isPositive: false },
  { name: 'Никтофобия (страх ночи)', emoji: '🌌', bonus: { morale: -10, energy: -4 }, isPositive: false },
  { name: 'Танатофобия (страх смерти)', emoji: '⚰️', bonus: { morale: -12 }, isPositive: false },
  { name: 'Гематофобия (страх ран и травм)', emoji: '🩹', bonus: { medicine: -8, morale: -4 }, isPositive: false },
  { name: 'Аэрофобия (страх шума сирен и полёта)', emoji: '✈️', bonus: { morale: -8, energy: -4 }, isPositive: false },
  ...
  { name: 'Тафофобия (страх быть погребённым заживо)', emoji: '🪦', bonus: { morale: -14, energy: -3 }, isPositive: false },
  { name: 'Гермофобия', emoji: '🧼', bonus: { morale: -8, medicine: -4 }, isPositive: false },
  { name: 'Кинофобия (страх собак)', emoji: '🐕', bonus: { morale: -6, food: -4 }, isPositive: false },
  { name: 'Офидиофобия (страх змей)', emoji: '🐍', bonus: { morale: -6 }, isPositive: false },
  { name: 'Эметофобия (страх рвоты и тошноты)', emoji: '🤢', bonus: { medicine: -6, morale: -5 }, isPositive: false },
  { name: 'Астрафобия (страх грома)', emoji: '⛈️', bonus: { morale: -8, energy: -3 }, isPositive: false },
  { name: 'Технофобия', emoji: '📟', bonus: { energy: -10 }, isPositive: false },
  { name: 'Глоссофобия (страх выступлений)', emoji: '🎤', bonus: { morale: -9 }, isPositive: false },
  { name: 'Некрофобия', emoji: '☠️', bonus: { morale: -10, medicine: -3 }, isPositive: false },
  { name: 'Катоптрофобия (страх зеркал и отражений)', emoji: '🪞', bonus: { morale: -5 }, isPositive: false },
  { name: 'Бронтофобия (страх взрывов)', emoji: '💥', bonus: { morale: -10, energy: -4 }, isPositive: false },
];
...
const ITEMS: AttributeEntry[] = [
  ...
  { name: 'Энциклопедия выживания', emoji: '📕', bonus: { food: 5, medicine: 5, energy: 5 }, isPositive: true },
  ...
  { name: 'Рюкзак выживальщика', emoji: '🎒', bonus: { food: 5, water: 5, energy: 5 }, isPositive: true },
  { name: 'Таблетки для обеззараживания', emoji: '🫧', bonus: { water: 15, medicine: 5 }, isPositive: true },
  ...
  { name: 'Полевой справочник растений', emoji: '📗', bonus: { food: 6, medicine: 6 }, isPositive: true },
  ...
  { name: 'Просроченные консервы', emoji: '🥫', bonus: { food: 4, medicine: -6 }, isPositive: false },
];
...
const SPECIAL_FACTS: AttributeEntry[] = [
  ...
  { name: 'Знает рецепты народной медицины', emoji: '🌿', bonus: { medicine: 12 }, isPositive: true },
  { name: 'Снайпер с опытом боевых действий', emoji: '🎯', bonus: { energy: 15 }, isPositive: true },
  { name: 'Выжил при прошлой эпидемии', emoji: '🏅', bonus: { medicine: 10, morale: 10 }, isPositive: true },
  { name: 'Знает тайный запасной вход', emoji: '🔒', bonus: { energy: 10, food: 5 }, isPositive: true },
  { name: 'Работал на строительстве бункера', emoji: '🏗️', bonus: { energy: 12, water: 5 }, isPositive: true },
  { name: 'Имеет радиолюбительскую лицензию', emoji: '📻', bonus: { morale: 10, energy: 5 }, isPositive: true },
  { name: 'Был в экспедиции в Антарктиде', emoji: '🧊', bonus: { food: 8, morale: 8 }, isPositive: true },
  { name: 'Создавал системы жизнеобеспечения', emoji: '🏭', bonus: { energy: 15 }, isPositive: true },
  ...
  { name: 'Имеет хронический конфликт с коллегами', emoji: '😠', bonus: { morale: -10 }, isPositive: false },
  { name: 'Отличник и перфекционист', emoji: '🎓', bonus: { morale: 5, medicine: 5 }, isPositive: true },
  { name: 'Богатый инвестор (без полезных навыков)', emoji: '💰', bonus: { morale: -5 }, isPositive: false },
  { name: 'Прожил год в изоляции', emoji: '🏔️', bonus: { morale: 10, energy: 5 }, isPositive: true },
  { name: 'Прошёл курсы тактической медицины', emoji: '🩹', bonus: { medicine: 14, energy: 4 }, isPositive: true },
  { name: 'Жил в автономном доме', emoji: '🏡', bonus: { energy: 10, water: 8 }, isPositive: true },
  { name: 'Умеет чинить фильтры воды', emoji: '💧', bonus: { water: 14, energy: 4 }, isPositive: true },
  { name: 'Организовывал гуманитарные миссии', emoji: '📦', bonus: { morale: 12, food: 4 }, isPositive: true },
  { name: 'Работал в тепличном комплексе', emoji: '🌿', bonus: { food: 14, water: 4 }, isPositive: true },
  { name: 'Служил связистом', emoji: '📡', bonus: { energy: 10, morale: 5 }, isPositive: true },
  { name: 'Вырос в деревне без удобств', emoji: '🚜', bonus: { food: 8, water: 6, morale: 4 }, isPositive: true },
  { name: 'Участвовал в арктической зимовке', emoji: '🧊', bonus: { energy: 8, morale: 8 }, isPositive: true },
  { name: 'Был волонтёром Красного Креста', emoji: '⛑️', bonus: { medicine: 12, morale: 6 }, isPositive: true },
  { name: 'Собирал тревожные рюкзаки до катастрофы', emoji: '🎒', bonus: { food: 6, water: 6, energy: 6 }, isPositive: true },
  { name: 'Работал диспетчером кризисного центра', emoji: '☎️', bonus: { morale: 10, energy: 4 }, isPositive: true },
  { name: 'Имеет опыт жизни на подлодке', emoji: '🚢', bonus: { morale: 10, energy: 5 }, isPositive: true },
  { name: 'Проходил курсы химзащиты', emoji: '☣️', bonus: { medicine: 10, water: 5 }, isPositive: true },
  { name: 'Умеет добывать огонь без спичек', emoji: '🔥', bonus: { energy: 10, morale: 3 }, isPositive: true },
  { name: 'Был старостой спасательного лагеря', emoji: '🏕️', bonus: { morale: 12, food: 3 }, isPositive: true },
  { name: 'Долги и криминальные связи', emoji: '💸', bonus: { morale: -10, energy: 4 }, isPositive: false },
  { name: 'Склонен скрывать важную информацию', emoji: '🤐', bonus: { morale: -8 }, isPositive: false },
  { name: 'Сбежал из секты выживальщиков', emoji: '🕯️', bonus: { morale: -5, food: 5, energy: 5 }, isPositive: false },
  { name: 'Потерял семью в первые дни катастрофы', emoji: '🖤', bonus: { morale: -10, energy: 3 }, isPositive: false },
  { name: 'Имеет репутацию мародёра', emoji: '🪓', bonus: { food: 5, morale: -12 }, isPositive: false },
];
...
export const SURVIVAL_EVENTS: SurvivalEvent[] = [
  {
    title: 'Прорыв трубы',
    description: 'Водопроводная труба лопнула из-за перепада давления. Часть запасов воды потеряна.',
    emoji: '🚰',
    effect: { water: -20 },
    positive: false,
  },
