...
const PHOBIAS: AttributeEntry[] = [
    ...
    {name: 'Аквафобия', emoji: '🌊', bonus: {water: -8, morale: -15}, isPositive: false},
    {
        ...
        emoji: '🏔️',
        bonus: {energy: -14, morale: -12},
        isPositive: false,
    },
    {
        name: 'Никтофобия (страх ночи)',
        emoji: '🌌',
        bonus: {morale: -10, energy: -14},
        isPositive: false,
    },
    ...
    {
        name: 'Фотофобия (страх яркого света)',
        emoji: '💡',
        bonus: {energy: -12, morale: -10},
        isPositive: false,
    },
    ...
    // Добавленные элементы для выравнивания баланса до 85 штук
    {
        name: 'Погонофобия (страх перед бородами)',
        emoji: '🧔',
        bonus: {morale: -8},
        isPositive: false,
    },
    {
        name: 'Микофобия (страх перед грибами)',
        emoji: '🍄',
        bonus: {food: -8, morale: -6},
        isPositive: false,
    },
    {
        name: 'Кинетофобия (страх движения и транспорта)',
        emoji: '🏃',
        bonus: {energy: -12},
        isPositive: false,
    },
    {
        name: 'Барофобия (страх гравитации и давления)',
        emoji: '🏋️',
        bonus: {energy: -14},
        isPositive: false,
    },
    {
        name: 'Метеорофобия (страх изменений погоды)',
        emoji: '☁️',
        bonus: {morale: -10},
        isPositive: false,
    },
